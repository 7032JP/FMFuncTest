...
;         1.14 メイン－サブ ブロック間インタフェース仕様 / 1.20 ミニフロッピィディスク インタフェースカード /
;         2.2.17 メイン－サブインタフェース解説
...
;       ハードウェア解説) の記載に基づく
;       (画面モードレジスタ $FD12 / $FD04、アナログパレット $FD30-$FD34、バスマウス $FDE8、
;        OPN ジョイスティック端子 $FD15/$FD16、VRAM バンクセレクト $D42F)
;
