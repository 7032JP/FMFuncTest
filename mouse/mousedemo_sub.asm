...
;         1.3.8-1.3.13 ブロック図 (サブ側) / 1.6 パレット機能 / 1.7 マルチページ機能 /
;         1.14 メイン－サブ ブロック間インタフェース仕様 / 2.2.17 メイン－サブインタフェース解説
;     - F-BASIC 解析マニュアル フェーズIII サブシステム編
;         第2章 サブシステムのアーキテクチャ (サブシステムのメモリマップ、共有 RAM、CRTC による VRAM、
;         マルチページ制御)
;     - FM77AV 固有の機能は FM77AV シリーズの公式資料 (ユーザーズマニュアル /
;       ハードウェア解説) の記載に基づく
;       (320x200 4096 色 / 640x400 8 色 / 320x200 262144 色の VRAM プレーン構成、
;        $D430 のページ選択、VRAM バンクセレクト $D42F)
;
...
;      (行41-52、押下中は点灯) を描画
;   5. 共有RAMの受け渡し領域 (座標・ボタン・モード・方式) を監視
